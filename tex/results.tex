...
\section{Generalized Lemma 7 of Friedgut}
	...
	Let $C = \{1, \ldots, m\}$ be a set of alternatives, and let $a,b \in C$ be any two alternatives. We define an anonymized version of the alternatives as $C' = \{c_1, \ldots, c_m\}$, totally ordered as $c_1 < \ldots < c_m$.
...
\section{Generalized Lemma 8 of Friedgut}
	...
	In this section we will fix a profile $p$, and for the sake of readability we rename the orderings:
	\begin{align*}
		\le &\textrm{ is } \le_s^G \\
