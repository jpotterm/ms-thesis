...
\chapter{Results}
	...
	In this chapter we will attempt to generalize step 3 of Friedgut, Kalai, and Nisan by way of generalizing their Lemma 6, Lemma 7, and Lemma 8. However, we will begin the chapter with some general lattice theory results that we will need later on in the chapter.
...
\section{Main Theorem}
	...
	\begin{lemma}[Lemma 3 of Friedgut et al.]
...
\section{Generalized Lemma 6 of Friedgut et al.}
	...
	Before we state Lemma \ref{friedgut-lemma-6}, recall the definition of $M^{a,b}(f)$ from Friedgut, Kalai, and Nisan \cite{friedgut2008elections}:
	\[
	...
	\begin{lemma}[See Lemma 6 of Friedgut et al.]
...
\section{Generalized Lemma 7 of Friedgut et al.}
	...
	We now generalize Lemma 7 of Friedgut, Kalai, and Nisan. Their original lemma is:

	\begin{lemma}[See Lemma 7 of Friedgut et al.]
		\[
	...
	\begin{corollary}[See Corollary 1 of Friedgut et al.]
		\[
...
\section{Generalized Lemma 8 of Friedgut et al.}
	...
	We now generalize Lemma 8 of Friedgut, Kalai, and Nisan. Their original lemma is:

	\begin{lemma}[See Lemma 8 of Friedgut et al.]
...
\section{Finished Step 3 of Friedgut et al.}
...
\section{Main Theorem of Friedgut et al.}

	Now we can use Friedgut, Kalai, and Nisan's generalized steps 1 and 2 along with our generalized version of step 3 to prove a general version of their main theorem. We will restate their generalized lemmas from step 1 and 2.

	\begin{lemma}[Lemma 1 of Friedgut et al.]
	...
	\begin{lemma}[Lemma 2 of Friedgut et al.]
	...
	And we restate our generalized version of Friedgut, Kalai, and Nisan's Lemma 3.

	\begin{conjecture}[Lemma 3 of Friedgut et al.]
		\label{friedgut-lemma-3}
		For every SCF $f$ on $m$ alternatives and every $a,b \in A$, $M^{a,b} \le \sum_i M_i \cdot m!$
	\end{conjecture}

	With these three lemmas we can now prove a generalized version of Friedgut, Kalai, and Nisan's main theorem.

	\begin{conjecture}[Theorem 1 of Friedgut et al.]
