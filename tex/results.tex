...
\section{Generalized Lemma 7 of Friedgut}
	...
	\begin{proof}
		...
		\]
		and view $A(p), B(p)$, as residing in $P'$. This is because any vote in $A(p)$ or $B(p)$, cannot possibly be in $L(C)^n \backslash P'$, since by definition the elements of these sets agree with $p|_{\{a,b\}}$. Clearly $|P'| = (\frac{m!}{2})^n$.
...
\section{Generalized Lemma 8 of Friedgut}
	...
	\noindent And our generalization is as follows.
